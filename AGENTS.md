...
- **ASR + Translation:** Soniox (`stt-rt-v5`) via WebSocket — handles both transcription and one-way translation
...
- **Soniox handles both ASR and translation** — no Codex API dependency
